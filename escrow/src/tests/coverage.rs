...
fn test_sme_collateral_no_token_balance_change() {
    ...
    assert_eq!(balance_after_first, balance_before,
        "First record_sme_collateral_commitment must not change token balance");
    ...
    assert_eq!(balance_after_second, balance_before,
        "Replacement record_sme_collateral_commitment must not change token balance");
